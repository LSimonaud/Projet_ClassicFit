...
public class Client extends Utilisateur{
    ...
    private int numero_telephone; //numero de telephone du client
    ...
    public Client(String email,String mdp,String nom,String prenom,LocalDate date_naissance,int numero_telephone,String addresse,String type_abonnement){
        super(email,mdp);
        this.nom = nom;
        this.prenom = prenom;
